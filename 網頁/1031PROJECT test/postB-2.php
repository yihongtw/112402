...
<body>
    ...
    <form action="" method="post" name="formPost" id="formPost" onSubmit="return checkForm();">
        <table width="90%" border="0" align="center" cellpadding="4" cellspacing="0">
            <tr valign="top">
                <td class="book" width="80" align="center"><img style="box-shadow:3px 3px 12px black;" src="images/book1-2.png" alt="我要留言" width="200" height="200"><span class="heading"></span></td>
                <td>
