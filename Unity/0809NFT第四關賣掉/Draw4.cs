            ...
            switch(progress){
                ...
                case 2:                                                                    
                                ...
                                msgSys.SetupButtonItem("DefaultButtonItemPrefab","提出報價",()=>{
                                    ...
                                    msgSys.SetupButtonUIPrefab("DefaultButtonUIPrefab");
                                    msgSys.SetupButtonItem("DefaultButtonItemPrefab","90,000",()=>{
                                        msgSys.Resume();
                                        msgSys.RemoveButtonUI();
                                    ...
                                    msgSys.SetupButtonItem("DefaultButtonItemPrefab","80,000",()=>{
                                        msgSys.Resume();
                                        msgSys.RemoveButtonUI();
                                        ...
                                        msgSys.SetupButtonItem("DefaultButtonItemPrefab","70,000",()=>{
                                            msgSys.Resume();
                                            msgSys.RemoveButtonUI();
                                            msgSys.ReadTextFromResource("買家不接受此報價");
                                            Money.text = money.ToString();
