...
//未加限制顯示筆數的SQL敘述句
$query_RecBoard = "SELECT * FROM totalbook ORDER BY boardtime DESC";
...
<body style="background-color:	#f5f5dc;">
      ...
      <td background="images/board_r3_c1.jpg">
        <div id="mainRegion">
          ...
          while ($row_RecBoard = $RecBoard->fetch_assoc()) {
            ...
            //$user_bookid = $stmt->get_result()->fetch_assoc();
  ...
  <div><a class="bdgohome" href="postB-10.php"><img name="" src="images/我要留言.jpg" width="110" height="36" ,border="0" alt="我要留言"></a></div>
