...
public class SaleDraw2 : MonoBehaviour
{
        ...
        if(msgSys.isCompleted && isSign && draw1 ){
            switch(progress){
                ...
                case 2:                                  
                    ...
                    msgSys.SetupButtonItem("DefaultButtonItemPrefab","12,000",()=>{ 
                        msgSys.Resume();
                        msgSys.RemoveButtonUI();
                        msgSys.ReadTextFromResource("Hide");
                        money = money + 12000;
                        string substringToRemove = "蒼穹雪夢";
                    ...
                    msgSys.SetupButtonItem("DefaultButtonItemPrefab","13,000",()=>{ 
                        msgSys.Resume();
                        msgSys.RemoveButtonUI();
                        msgSys.ReadTextFromResource("Hide");
                        msgSys.ReadTextFromResource("沒有買家購買");
                    });    
                    msgSys.SetupButtonItem("DefaultButtonItemPrefab","14,000",()=>{ 
                        msgSys.Resume();
                        msgSys.RemoveButtonUI();
                        msgSys.ReadTextFromResource("Hide");
                        msgSys.ReadTextFromResource("沒有買家購買");
