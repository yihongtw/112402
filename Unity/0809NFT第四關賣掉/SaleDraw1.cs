...
public class SaleDraw1 : MonoBehaviour
{
        ...
        if(msgSys.isCompleted && isSign && draw1 ){
            switch(progress){
                ...
                case 2:                                  
                    ...
                    msgSys.SetupButtonItem("DefaultButtonItemPrefab","5,500",()=>{ 
                        msgSys.Resume();
                        msgSys.RemoveButtonUI();
                        msgSys.ReadTextFromResource("Hide");
                        money = money + 5500;
                        string substringToRemove = "港岸風情";
                    ...
                    msgSys.SetupButtonItem("DefaultButtonItemPrefab","6,000",()=>{ 
                        msgSys.Resume();
                        msgSys.RemoveButtonUI();
                        msgSys.ReadTextFromResource("Hide");
