...
<nav>
    ...
    <nav class="store1">
        <div class="book1-1">
            <p>▲開始在股市賺錢最要緊的大小事</p>
            <a href="post1-1.php"><img src="images/book1-1.png"></a>
        </div>
        <div class="book1-2">
            <p>▲投資中最簡單的事</p>
            <a href="post1-2.php"><img src="images/book1-2.png" ></a>
        </div>
        <div class="book1-3">
            <p>▲持續買進</p>
            <a href="post1-3.php"><img src="images/book1-3.png" ></a>
        </div>
        <div class="book1-4">
            <p>▲槓桿ETF投資法</p>
            <a href="post1-4.php"><img src="images/book1-4.png" ></a>
        </div>
        <div class="book1-5">
            <p>▲華爾街的華爾滋</p>
            <a href="post1-5.php"><img src="images/book1-5.png" ></a>
        </div>
        <div class="book1-6">
            <p>▲Excel 選股法</p>
            <a href="post1-6.php"><img src="images/book1-6.png"></a>
        </div>
        <div class="book1-7">
            <p>▲全息人生</p>
            <a href="post1-7.php"><img src="images/book1-7.png" ></a>
        </div>
        <div class="book1-8">
            <p>▲3天搞懂買賣股票</p>
            <a href="post1-8.php"><img src="images/book1-8.png" ></a>
        </div>
        <div class="book1-9">
            <p>▲Python股票xETF量化交易</p>
            <a href="post1-9.php"><img src="images/book1-9.png" ></a>
        </div>
        <div class="book1-10">
            <p>▲漫步股市:給存股族的12個致富心法</p>
            <a href="post1-10.php"><img src="images/book1-10.png" ></a>
        </div>
    </nav>
