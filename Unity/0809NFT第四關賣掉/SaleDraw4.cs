...
public class SaleDraw4 : MonoBehaviour
{
        ...
        if(msgSys.isCompleted && isSign && draw1 ){
            switch(progress){
                ...
                case 2:                                  
                    ...
                    msgSys.SetupButtonItem("DefaultButtonItemPrefab","120,000",()=>{ 
                        msgSys.Resume();
                        msgSys.RemoveButtonUI();
                        msgSys.ReadTextFromResource("Hide");
                        money = money + 120000;
                        string substringToRemove = "粉色春天";
                    ...
                    msgSys.SetupButtonItem("DefaultButtonItemPrefab","130,000",()=>{ 
                        msgSys.Resume();
                        msgSys.RemoveButtonUI();
                        msgSys.ReadTextFromResource("Hide");
                        msgSys.ReadTextFromResource("沒有買家購買");
                    });    
                    msgSys.SetupButtonItem("DefaultButtonItemPrefab","140,000",()=>{ 
                        msgSys.Resume();
                        msgSys.RemoveButtonUI();
                        msgSys.ReadTextFromResource("Hide");
                        msgSys.ReadTextFromResource("沒有買家購買");
