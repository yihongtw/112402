...
public class Parkwoman : MonoBehaviour
{
    [SerializeField]
    ...
    void Update()
    {
        ...
        if (msgSys.isCompleted && isSign)
        {
            switch (progress)
            {
                case 0:
                    msgSys.Resume();
                    msgSys.ReadTextFromResource("歡迎");

                    break;
                case 1:
                    //msgSys.SetDisplayVariable("MyName", myName);
                    msgSys.ReadTextFromResource("推薦樓層嗎");
                ...
                case 2:
                    ...
                    msgSys.SetupButtonItem(
                        ...
                        () =>
                        {
                            ...
                            msgSys.ReadTextFromResource("虛擬貨幣yes");
                            msgSys.SetupButtonUIPrefab("DefaultButtonUIPrefab");
                            msgSys.SetupButtonItem(
                                "DefaultButtonItemPrefab",
                                "有曾經想過",
                                () =>
                                {
                                    msgSys.Resume();
                                    msgSys.RemoveButtonUI();
                                    msgSys.ReadTextFromResource("虛擬yes");
                                    msgSys.SetupButtonUIPrefab("DefaultButtonUIPrefab");
                                    msgSys.SetupButtonItem(
                                        "DefaultButtonItemPrefab",
                                        "有試著這麼做",
                                        () =>
                                        {
                                            msgSys.Resume();
                                            msgSys.RemoveButtonUI();
                                            msgSys.ReadTextFromResource("虛擬規劃yes");
                                            msgSys.SetupButtonUIPrefab("DefaultButtonUIPrefab");
                                            msgSys.SetupButtonItem(
                                                "DefaultButtonItemPrefab",
                                                "閱讀過且有需要尋找更多書籍",
                                                () =>
                                                {
                                                    msgSys.Resume();
                                                    msgSys.RemoveButtonUI();
                                                    msgSys.ReadTextFromResource("虛擬需要更多");
                                                    msgSys.SetupButtonUIPrefab(
                                                        "DefaultButtonUIPrefab"
                                                    );
                                                    msgSys.SetupButtonItem(
                                                        "DefaultButtonItemPrefab",
                                                        "是",
                                            ...
                                            msgSys.SetupButtonItem(
                                                ...
                                                () =>
                                                {
                                                    msgSys.Resume();
                                                    msgSys.RemoveButtonUI();
                                                    msgSys.ReadTextFromResource("虛擬讀過幾本");
                                                    msgSys.SetupButtonUIPrefab(
                                                        "DefaultButtonUIPrefab"
                                                    );
                                                    msgSys.SetupButtonItem(
                                    ...
                                    msgSys.SetupButtonItem(
                                        ...
                                        () =>
                                        {
                                            msgSys.Resume();
                                            msgSys.RemoveButtonUI();
                                            msgSys.ReadTextFromResource("虛擬規劃no");
                                            msgSys.SetupButtonUIPrefab("DefaultButtonUIPrefab");
                                            msgSys.SetupButtonItem(
                                                "DefaultButtonItemPrefab",
                                                "是",
                            ...
                            msgSys.SetupButtonItem(
                                ...
                                () =>
                                {
                                    msgSys.Resume();
                                    msgSys.RemoveButtonUI();
                                    msgSys.ReadTextFromResource("虛擬no");
                                    msgSys.SetupButtonUIPrefab("DefaultButtonUIPrefab");
                                    msgSys.SetupButtonItem(
                                        "DefaultButtonItemPrefab",
                                        "有曾經想過",
                    ...
                    msgSys.SetupButtonItem(
                        ...
                        () =>
                        {
                            msgSys.Resume();
                            msgSys.RemoveButtonUI();
                            msgSys.ReadTextFromResource("虛擬貨幣no");
                        }
                    );
