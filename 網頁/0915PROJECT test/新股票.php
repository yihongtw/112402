...
<body>
    ...
    <form style="width:800px; height:500px; background-color:#96FF96; position:absolute;right:0px" action="" method="post">
        <label for="selected_book">請選擇書籍：</label>
        <select id="selected_book" name="selected_book" onchange="showImage()">
        ...
        <button><a id="share_button" href="#">心得分享</a></button>
    </form>
