...
<body>
    <nav class="home">
        <table> 
            <tr>
                <td>
                    <a class="bd5" href="不動產2-3.php"><img name="board_r1_c5" src="images/瀏覽留言2.jpg" width="110" height="36" ,border="0" alt="瀏覽留言"></a>
                </td>
            </tr>
        </table>
    </nav>
    ...
    <form action="" method="post" name="formPost" id="formPost" onSubmit="return checkForm();">
        <table width="90%" border="0" align="center" cellpadding="4" cellspacing="0">
            <tr valign="top">
                <td class="book" width="80" align="center"><img style="box-shadow:3px 3px 12px black;" src="images/book2-3.png" width="200" height="200"><span class="heading"></span></td>
                <td>
