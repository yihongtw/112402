            ...
            switch(progress){
                ...
                case 2:                                                                    
                                ...
                                msgSys.SetupButtonItem("DefaultButtonItemPrefab","提出報價",()=>{
                                    ...
                                    msgSys.SetupButtonUIPrefab("DefaultButtonUIPrefab");
                                    msgSys.SetupButtonItem("DefaultButtonItemPrefab","4,500",()=>{
                                        msgSys.Resume();
                                        msgSys.RemoveButtonUI();
                                    ...
                                    msgSys.SetupButtonItem("DefaultButtonItemPrefab","3,500",()=>{
                                        msgSys.Resume();
                                        msgSys.RemoveButtonUI();
                                        ...
                                        msgSys.SetupButtonItem("DefaultButtonItemPrefab","3,000",()=>{
                                            msgSys.Resume();
                                            msgSys.RemoveButtonUI();
                                            msgSys.ReadTextFromResource("買家不接受此報價");
                                            Money.text = money.ToString();
