...
//未加限制顯示筆數的SQL敘述句
$query_RecBoard = "SELECT * FROM board11 ORDER BY boardtime DESC";
...
<body>
  ...
  <div><a class="bdgohome" href="postB-1.php"><img name="" src="images/送出留言.jpg" width="110" height="36" ,border="0" alt=""></a></div>
  <div><a class="commentbdgohome" href="首頁.php"><img name="" src="images/留言板回到首頁.png" width="110" height="36" ,border="0" alt="回到首頁"></a></div>
</body>
